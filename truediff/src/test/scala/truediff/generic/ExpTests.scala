...
import truediff.generic.Exp.Hole
...
class ExpTests extends AnyFlatSpec with Matchers {
  ...
  /*
Comparing:
  Add_231f98ef(Add_7c137fd5(Num_183ec003(2), Num_7d9d0818(3)), Add_221a3fa4(Num_451001e5(2), Num_2b40ff9c(3)))
  Add_3e08ff24(Add_4d1c005e(Num_8462f31(2), Num_24569dba(3)), Num_5ddeb7cb(2))
EditScript:
  detach+unload truediff.manual.Add_221a3fa4(e1=451001e5, e2=2b40ff9c) from truediff.manual.Add_231f98ef.e2
  unload truediff.manual.Num_2b40ff9c(n=3)
  attach truediff.manual.Num_451001e5 to truediff.manual.Add_231f98ef.e2
New tree:
  Add_231f98ef(Add_7c137fd5(Num_183ec003(2), Num_7d9d0818(3)), Num_451001e5(2))
   */
